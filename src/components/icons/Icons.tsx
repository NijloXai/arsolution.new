/* =========================
   AR+Solution - Icones centralisees
   Toutes les icones SVG du projet
   ========================= */
...
export function WallIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function InsulationIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LayoutIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PaintIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FinishIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function BuildingOfficeIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function BuildingLandmarkIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CalendarCheckIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function StarIcon({ size = 24, className, filled = false, ...props }: StarIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SchoolIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function OfficeIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function HospitalIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
const SERVICE_ICON_MAP: Record<ServiceIconType, (props: IconProps) => React.ReactNode> = {
  wall: WallIcon,
...
export function ServiceIcon({ type, size = 32 }: { type: ServiceIconType; size?: number }) {
  const IconComponent = SERVICE_ICON_MAP[type] ?? WallIcon;
  return <IconComponent size={size} />;
}

// =========================
// HELPER - Trust Icon Switcher
// =========================

export function TrustIcon({ type, size = 32 }: { type?: string; size?: number }) {
  switch (type) {
    case 'rge':
...
// =========================
// HELPER - Profile Icon Switcher
// =========================

export function ProfileIcon({ type, size = 32 }: { type?: string; size?: number }) {
  switch (type) {
    case 'building':
...
// =========================
// HELPER - WhyUs Icon Switcher
// =========================

export function WhyUsIcon({ type, size = 28 }: { type: string; size?: number }) {
  switch (type) {
    case 'calendar':
